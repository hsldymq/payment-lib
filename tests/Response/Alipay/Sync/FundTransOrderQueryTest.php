...
class FundTransOrderQueryTest extends TestCase
{
    public function testSignatureValidation()
    {
        ...
        foreach ($cases as $each) {
            ...
            ['signName' => $signName, 'responseName' => $responseName] = ResponseHelper::getResponseFieldName(FundTransOrderQuery::class);
    ...
    public function testDecryption()
    {
        ...
        foreach ($cases as $each) {
            ...
            ['responseName' => $responseName] = ResponseHelper::getResponseFieldName(FundTransOrderQuery::class);
            $content = OpenAPIResponseParser::getResponseContent($each['body'], $responseName);
